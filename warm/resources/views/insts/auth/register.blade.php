    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('inistUserRegister') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="inst_id" class="col-md-4 col-form-label text-md-right">{{ __('inst_id') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="j_title" class="col-md-4 col-form-label text-md-right">{{ __('j_title') }}</label>
